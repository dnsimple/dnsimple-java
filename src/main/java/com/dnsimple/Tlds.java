...
public interface Tlds {
     ...
     */
    PaginatedResponse<Tld> listTlds() throws DnsimpleException, IOException, InterruptedException;
     ...
     * @see <a href="https://developer.dnsimple.com/v2/tlds/#list">https://developer.dnsimple.com/v2/tlds/#list</a>
     */
    PaginatedResponse<Tld> listTlds(Map<String, Object> options) throws DnsimpleException, IOException, InterruptedException;
     ...
     */
    SimpleResponse<Tld> getTld(String tld) throws DnsimpleException, IOException, InterruptedException;
     ...
     */
    ListResponse<TldExtendedAttribute> getTldExtendedAttributes(String tld) throws DnsimpleException, IOException, InterruptedException;
}
