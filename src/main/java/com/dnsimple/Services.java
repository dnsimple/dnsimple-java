...
public interface Services {
     ...
     */
    ListResponse<Service> listServices();
     ...
     * @see <a href="https://developer.dnsimple.com/v2/services/#list">https://developer.dnsimple.com/v2/services/#list</a>
     */
    ListResponse<Service> listServices(Map<String, Object> options);
     ...
     */
    SimpleResponse<Service> getService(String serviceId);
     ...
     */
    PaginatedResponse<Service> appliedServices(String accountId, String domainId);
     ...
     * @see <a href="https://developer.dnsimple.com/v2/services/domains/#applied">https://developer.dnsimple.com/v2/services/domains/#applied</a>
     */
    PaginatedResponse<Service> appliedServices(String accountId, String domainId, Map<String, Object> options);
     ...
     */
    SimpleResponse<Service> applyService(String accountId, String domainId, String serviceId, Map<String, Object> settings);
     ...
     * @see <a href="https://developer.dnsimple.com/v2/services/domains/#apply">https://developer.dnsimple.com/v2/services/domains/#apply</a>
     */
    SimpleResponse<Service> unapplyService(String accountId, String domainId, String serviceId);
}
