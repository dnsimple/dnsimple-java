...
public class DomainsEndpoint implements Domains {
     ...
     */
    public PaginatedResponse<Domain> listDomains(String accountId) {
     ...
     * @see <a href="https://developer.dnsimple.com/v2/domains/#list">https://developer.dnsimple.com/v2/domains/#list</a>
     */
    public PaginatedResponse<Domain> listDomains(String accountId, Map<String, Object> options) {
     ...
     */
    public SimpleResponse<Domain> getDomain(String accountId, String domainId) {
     ...
     */
    public SimpleResponse<Domain> createDomain(String accountId, Map<String, Object> attributes) {
     ...
     */
    public EmptyResponse deleteDomain(String accountId, String domainId) {
     ...
     */
    public SimpleResponse<Domain> resetDomainToken(String accountId, String domainId) {
     ...
     */
    public PaginatedResponse<Collaborator> listCollaborators(String accountId, String domainId) {
     ...
     * @see <a href="https://developer.dnsimple.com/v2/collaborators/#list">https://developer.dnsimple.com/v2/collaborators/#list</a>
     */
    public PaginatedResponse<Collaborator> listCollaborators(String accountId, String domainId, Map<String, Object> options) {
     ...
     */
    public SimpleResponse<Collaborator> addCollaborator(String accountId, String domainId, Map<String, Object> attributes) {
     ...
     */
    public EmptyResponse removeCollaborator(String accountId, String domainId, String collaboratorId) {
     ...
     */
    public SimpleResponse<Dnssec> enableDnssec(String accountId, String domainId) {
     ...
     */
    public EmptyResponse disableDnssec(String accountId, String domainId) {
     ...
     */
    public SimpleResponse<Dnssec> getDnssec(String accountId, String domainId) {
     ...
     */
    public PaginatedResponse<DelegationSignerRecord> listDelegationSignerRecords(String accountId, String domainId) {
     ...
     * @see <a href="https://developer.dnsimple.com/v2/domains/dnssec/#ds-record-list">https://developer.dnsimple.com/v2/domains/dnssec/#ds-record-list</a>
     */
    public PaginatedResponse<DelegationSignerRecord> listDelegationSignerRecords(String accountId, String domainId, Map<String, Object> options) {
     ...
     */
    public SimpleResponse<DelegationSignerRecord> getDelegationSignerRecord(String accountId, String domainId, String dsRecordId) {
     ...
     */
    public SimpleResponse<DelegationSignerRecord> createDelegationSignerRecord(String accountId, String domainId, Map<String, Object> attributes) {
     ...
     */
    public EmptyResponse deleteDelegationSignerRecord(String accountId, String domainId, String dsRecordId) {
     ...
     */
    public PaginatedResponse<EmailForward> listEmailForwards(String accountId, String domainId) {
     ...
     * @see <a href="https://developer.dnsimple.com/v2/domains/email-forwards/#list">https://developer.dnsimple.com/v2/domains/email-forwards/#list</a>
     */
    public PaginatedResponse<EmailForward> listEmailForwards(String accountId, String domainId, Map<String, Object> options) {
     ...
     */
    public SimpleResponse<EmailForward> getEmailForward(String accountId, String domainId, String emailForwardId) {
     ...
     */
    public SimpleResponse<EmailForward> createEmailForward(String accountId, String domainId, Map<String, Object> attributes) {
     ...
     */
    public EmptyResponse deleteEmailForward(String accountId, String domainId, String emailForwardId) {
     ...
     */
    public EmptyResponse acceptPush(String accountId, String pushId, Map<String, Object> attributes) {
     ...
     */
    public EmptyResponse rejectPush(String accountId, String pushId) {
