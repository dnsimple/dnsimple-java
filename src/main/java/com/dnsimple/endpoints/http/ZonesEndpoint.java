...
public class ZonesEndpoint implements Zones {
    ...
    public PaginatedResponse<Zone> listZones(String accountId) {
        return client.page(GET, accountId + "/zones", emptyMap(), null, Zone.class);
    }

    public PaginatedResponse<Zone> listZones(String accountId, Map<String, Object> options) {
        return client.page(GET, accountId + "/zones", options, null, Zone.class);
    }

    public SimpleResponse<Zone> getZone(String accountId, String zoneId) {
        return client.simple(GET, accountId + "/zones/" + zoneId, emptyMap(), null, Zone.class);
    }

    public SimpleResponse<ZoneFile> getZoneFile(String accountId, String zoneId) {
        return client.simple(GET, accountId + "/zones/" + zoneId + "/file", emptyMap(), null, ZoneFile.class);
    }

    public SimpleResponse<ZoneDistribution> checkZoneDistribution(String accountId, String zoneId) {
        return client.simple(GET, accountId + "/zones/" + zoneId + "/distribution", emptyMap(), null, ZoneDistribution.class);
    }

    public SimpleResponse<ZoneDistribution> checkZoneRecordDistribution(String accountId, String zoneId, String recordId) {
        return client.simple(GET, accountId + "/zones/" + zoneId + "/records/" + recordId + "/distribution", emptyMap(), null, ZoneDistribution.class);
    }

    public PaginatedResponse<ZoneRecord> listZoneRecords(String accountId, String zoneId) {
        return client.page(GET, accountId + "/zones/" + zoneId + "/records", emptyMap(), null, ZoneRecord.class);
    }

    public PaginatedResponse<ZoneRecord> listZoneRecords(String accountId, String zoneId, Map<String, Object> options) {
        return client.page(GET, accountId + "/zones/" + zoneId + "/records", options, null, ZoneRecord.class);
    }

    public SimpleResponse<ZoneRecord> getZoneRecord(String accountId, String zoneId, String recordId) {
        return client.simple(GET, accountId + "/zones/" + zoneId + "/records/" + recordId, emptyMap(), null, ZoneRecord.class);
    }

    public SimpleResponse<ZoneRecord> createZoneRecord(String accountId, String zoneId, Map<String, Object> attributes) {
        return client.simple(POST, accountId + "/zones/" + zoneId + "/records", emptyMap(), attributes, ZoneRecord.class);
    }

    public SimpleResponse<ZoneRecord> updateZoneRecord(String accountId, String zoneId, String recordId, Map<String, Object> attributes) {
        return client.simple(PATCH, accountId + "/zones/" + zoneId + "/records/" + recordId, emptyMap(), attributes, ZoneRecord.class);
    }

    public EmptyResponse deleteZoneRecord(String accountId, String zoneId, String recordId) {
