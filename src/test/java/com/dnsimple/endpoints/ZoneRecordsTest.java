...
public class ZoneRecordsTest extends DnsimpleTestBase {
    ...
    public void testListZoneRecordsSupportsPagination() {
        client.zones.listZoneRecords(1, "example.com", new ListOptions.Builder().page(1).build());
    ...
    public void testListZoneRecordsSupportsExtraRequestOptions() {
        client.zones.listZoneRecords(1, "example.com", new ListOptions.Builder().filter("foo", "bar").build());
        assertThat(server.getRecordedRequest().getMethod(), is(GET));
    ...
    public void testListZoneRecordsSupportsSorting() {
        client.zones.listZoneRecords(1, "example.com", new ListOptions.Builder().sortAsc("name").build());
        assertThat(server.getRecordedRequest().getMethod(), is(GET));
