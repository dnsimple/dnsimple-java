...
public class CertificatesTest extends DnsimpleTestBase {
  ...
  public void testLetsencryptPurchase() throws DnsimpleException, IOException {
    Client client = mockAndExpectClient("https://api.dnsimple.com/v2/1010/domains/weppos.net/certificates/letsencrypt", HttpMethods.POST, resource("letsencryptPurchase/success.http"));
