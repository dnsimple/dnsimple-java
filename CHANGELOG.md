...
- Added `batchChangeZoneRecords` to create, update, and delete records in a zone in one atomic request.
...
- Added `getDomainResearchStatus` to research a domain for availability and registration status. (#237)
